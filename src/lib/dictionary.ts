...
const dictionary = {
  ar: {
    ...
    formMailtoHint:
      "إن لم تُضبط خدمة نماذج مجانية، سيُفتح البريد لديك، ويمكنك أيضاً نسخ نص الطلب.",
    formSuccess: "تم إرسال طلبك. سيتواصل معك خالد السميري.",
    formCopy: "نسخ نص الطلب",
    formCopied: "تم النسخ",
  ...
  en: {
    ...
    formMailtoHint:
      "If a free form service is not set, your email app may open. You can also copy the request text.",
    formSuccess: "Your request has been sent. Khaled will contact you.",
    formCopy: "Copy request text",
    formCopied: "Copied",
